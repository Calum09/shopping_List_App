...
const appSettings = {
    databaseURL: "https://shoppingcart-45173-default-rtdb.europe-west1.firebasedatabase.app/"
}
...
addButton.addEventListener("click", function() { // Look to refactor this function into a separate one and call it on the eventlistener
...
onValue(shoppingListInDB, function(snapshot) {
    ...
    if (snapshot.exists()) { // If there's a snapshot run this code
